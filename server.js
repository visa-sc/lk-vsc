...
const LK_CHANGELOG = [
  { date: "05.07.2026", title: "Новая страница /amocrm_copy — полный слепок amoCRM (данные + автоматизации)", by: "задача Андрея (копия CRM для перехода на своё решение)", points: [
    "voyotravel.ru/amocrm_copy — обособленная страница-копия аккаунта amoCRM: воронки-канбан, сделки с карточками (поля, задачи, примечания), поиск по контактам, справочники (пользователи, 220 полей, теги, причины отказа), полные сценарии всех Salesbot и сырые триггеры цифровых воронок + опись автоматизаций и список доработок до рабочей CRM.",
    "Доступ: страница видна всем, но данные — только админу и руководителям с правом «vsc» (тот же вход, что /vsc). Слепок «только чтение», в живую amoCRM не ходит.",
