...
<li><b>«Бонусы» — кнопка-человечек (с 10.08.2026):</b> в правом нижнем углу кабинета, <b>на всех этапах</b>, поверх содержимого. Открывает шторку с бонусной картой: баланс, статус и его процент кэшбэка, прогресс до следующего статуса, строка «Кэшбэк / Баллами / Бюджет», заявка на списание баллов, реферальный код с кнопками WhatsApp/Telegram и история начислений; пояснения спрятаны под иконки «i». Кэшбэк зависит от суммы оплаченных услуг: Базовый 0%, Silver 5% от 50 000 ₽, Gold 7% от 150 000 ₽, Platinum 10% от 300 000 ₽; 1 балл = 1 ₽, оплатить баллами можно до 30% услуги; за приглашённого друга по 2 000 баллов обоим после его первой заявки. Списание: клиент оставляет заявку → менеджер подтверждает её в консоли /loyalty → баллы уходят из баланса. Телефон берётся из сессии voyo_sess. Раздел выключается рубильником LK_LOYALTY=0 в .env — тогда кнопки в ЛК нет.</li>
...
const LK_CHANGELOG = [
  { date: "10.08.2026", title: "«Бонусы» в ЛК — бонусная карта клиента (кнопка-человечек)", by: "задача Андрея", points: [
    ...
    "Внутри: бонусная карта (баланс, статус и его процент кэшбэка, прогресс до следующего статуса), строка фактов «Кэшбэк / Баллами / Бюджет», заявка на списание баллов, приглашение друзей с реф-кодом и история начислений. Все пояснения — под иконками «i», чтобы экран оставался коротким.",
    "Механика (та же, что на /loyalty и в /app): кэшбэк растёт со статусом — Базовый 0%, Silver 5% от 50 000 ₽, Gold 7% от 150 000 ₽, Platinum 10% от 300 000 ₽; 1 балл = 1 ₽; баллами можно оплатить до 30% услуги; за друга по 2 000 баллов обоим после его первой оформленной заявки. Считается из amoCRM автоматически (только чтение, раз в сутки).",
    "Списание: клиент оставляет заявку из карты → менеджер подтверждает её в консоли /loyalty → баллы уходят из баланса, в истории появляется «Оплата баллами». В amoCRM ничего не пишется, сумму к оплате менеджер уменьшает при оформлении.",
