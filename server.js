...
const LK_TESTER_SPEC = {
  ...
  directions: {
    schengen: {
      ...
      qnote: "⚠ Большинство вопросов «Да/Нет» технически можно пропустить (не помечены обязательными) — пропуск срабатывает как «Нет», и соответствующие документы не запросятся.",
      questions: [
    ...
    japan: {
      ...
      qnote: "⚠ «Цель визита» не обязательна: если клиент её пропустит, ЛК запросит «Приглашение» и «План поездки», как при не-туризме.",
      questions: [
