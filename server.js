  ...
  directions: {
    schengen: {
      ...
      docRecs: [
        ...
        "Справка по «Роду деятельности» разнесена (26.06): «Работа по найму» → «Справка с работы», «Учащийся» → «Справка с учёбы» (раздельно). Для «Владелец бизнеса или ИП» / «Самозанятый» / «Пенсионер» / «Безработный» справки на этапе «Подготовка документов» нет — их подтверждающие документы только в подобласти «перед подачей» (ИП/ООО — см. отдельную корректировку #4 «в работе»)."
      ],
      questions: [
...
<script>
  ...
  function updateConditionals() {
    ...
    const occEl = form.querySelector('[name="occupation"]');
    toggle("c_position", !!occEl && occEl.value === "Работа по найму");
