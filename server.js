...
const LK_CHANGELOG = [
  { date: "11.08.2026", title: "Меню кабинета «Визы / Бонусы» и оффер «Пригласите друга»", by: "задача Андрея", points: [
    ...
    "«Бонусы» открывают отдельный экран поверх кабинета (карта, прогресс, приглашение друзей, история); «Визы» возвращают к обращениям. Esc тоже возвращает. Содержимое кабинета при этом не меняется и не перерисовывается.",
