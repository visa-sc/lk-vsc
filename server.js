...
const LK_TESTER_SPEC = {
  ...
  stageSees: {
    0: [
      ...
      "Опросник Шенген включает новые вопросы (корректировки Риты): «Город подачи» + «Прописка в паспорте РФ в городе подачи?» (при «Нет» — город прописки) и блок «Данные принимающей стороны» при цели «Частный визит». Детали — во вкладке «Опросники (логика)».",
  ...
  screens: [
    { stage: 0, title: "0 · Начало оформления", sees: [
      ...
      "Опросник Шенген: новые вопросы (корректировки Риты) — «Город подачи» + «Прописка в паспорте РФ в городе подачи?» (при «Нет» — город прописки) и блок «Данные принимающей стороны» при цели «Частный визит» (см. «Опросники (логика)»).",
      "Над списком — красная плашка «Необходимо загрузить все документы ниже»; зеленеет, когда оба паспорта прикреплены."
    ], dot: [
