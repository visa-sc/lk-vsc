...
const KB_DOC_GROUPS = [
  ...
  { stage: "Подготовка документов (этап 2) — Шенген, обычный список", byStatus: true, docs: [
    ...
    { n: "Справка с работы или учёбы", c: "если «Род деятельности» = «Работа по найму» или «Учащийся»", r: true },
  ...
  directions: {
    schengen: {
      ...
      docsByStage: {
        ...
        "2": [
          ...
          { label: "Справка с работы или учёбы", when: "если «Род деятельности» = «Работа по найму» или «Учащийся»", cond: { f: "occupation", in: ["Работа по найму", "Учащийся"] } },
      ...
      questions: [
        ...
        { q: "Род занятий (6 вариантов)", req: "Да", shows: "всегда", effect: "«Работа по найму» или «Учащийся» → этап «Подготовка документов»: «Справка с работы или учёбы» (обяз.). Также влияет на подобласть «перед подачей» (за 7 дней до записи): «Владелец бизнеса или ИП» → «Документы на ИП»; «Учащийся» → «Справка из учебного заведения»; «Пенсионер» → «Пенсионное удостоверение/справка»; «Самозанятый» → «Справка о самозанятости» (все обязательные)." },
    ...
    japan: {
      ...
      docRecs: [
        ...
        "У учащегося справка об учёбе запрашивается дважды: «Справка с учёбы» (этап 1) и «Справка из учебного заведения» (подобласть «перед подачей»). Та же проблема дублей, что по Шенгену (см. корректировку «дубли документов» — в работе); решение по дедупу должно покрыть и Японию."
      ],
      questions: [
