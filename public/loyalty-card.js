...
(function (w, d) {
  ...
  function txtTiers(card) {
    ...
    return "<b>Статусы и кэшбэк</b><br>Процент зависит от суммы оплаченных вами услуг — "
      ...
      + "<div style='margin-top:9px;opacity:.72'>Первый статус даёт свой процент на всю сумму покупок. "
      + "Дальше повышенный процент действует на часть суммы сверх порога: при 60 000 ₽ это 5% с первых 50 000 ₽ "
      + "и 7% с оставшихся 10 000 ₽. Ранее начисленные баллы не пересчитываются.</div>"
      ...
      + "<br><br>Баллы начисляются автоматически после того, как услуга успешно завершена, и не сгорают.</div>";
  }
  function txtEarn(card) {
    ...
    return "<b>Как начисляются баллы</b><br>"
      + (rate > 0
        ? "Сейчас с каждой новой оплаты возвращается <b>" + rate + "%</b> баллами. 1 балл = 1 ₽."
        : "Кэшбэк включается со статуса <b>" + esc(first ? first.name : "Silver") + "</b> — от " + RU(first ? first.min : 50000) + " ₽ оплаченных услуг. 1 балл = 1 ₽.")
      + "<br><br>Начисление автоматическое — после того, как услуга успешно завершена. Активировать ничего не нужно."
  ...
  function txtSpend(card) {
    ...
    return "<b>Как потратить баллы</b><br>1 балл = 1 ₽. Баллами можно оплатить до <b>" + share
      ...
      + "<br><br>Скажите менеджеру при оформлении, что хотите оплатить баллами, — он спишет их и уменьшит сумму к оплате."
      + "<br><br>Минимум к списанию — " + RU(card.redeemMin || 500) + " баллов.";
  }
  function txtRef(ref) {
    return "<b>Как работает приглашение</b><br>Отправьте другу свою ссылку. Он зарегистрируется по ней — и <b>сразу</b> получит "
      + "<b>" + RU(ref.rewardFriend || 2000) + "</b> баллов, которыми можно оплатить часть услуги."
      + "<br><br>Ваши <b>" + RU(ref.rewardInviter || 2000) + "</b> баллов придут после того, как друг оплатит свою услугу."
      + "<br><br>Всё автоматически, количество приглашений не ограничено.";
  }
  ...
  function vRef(ref, refBase) {
    ...
    var s = el('<section><div class="vl-panel vl-invite">'
      ...
      + " ₽</b> — другу!<br>Другу баллы приходят сразу, вам — после его оплаты."
