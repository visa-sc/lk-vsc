...
// Шенген — по ВХОЖДЕНИЮ названия страны в значение поля «Страна оформления/услуга»
// (ловит «Италия Альмавива»/«Италия VMS» и любые варианты). Ирландия/Британия НЕ входят.
const KW = ["Австрия", "Бельгия", "Чехия", "Дания", "Эстония", "Финляндия", "Франция", "Германия", "Греция", "Венгрия", "Исландия", "Италия", "Латвия", "Литва", "Люксембург", "Мальта", "Нидерланды", "Норвегия", "Польша", "Португалия", "Словакия", "Словения", "Испания", "Швеция", "Швейцария", "Лихтенштейн", "Румыния", "Хорватия", "Болгария", "Кипр"];
