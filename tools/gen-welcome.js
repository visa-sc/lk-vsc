...
const CSS = `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-note { margin-top:28px; font-size:13px; color:var(--text-muted); }
    ...
    .cta p.cta-free { margin:26px auto 0; max-width:560px; font-size:14px; color:var(--text-muted); line-height:1.5; }
    .cta-free b { color:var(--accent-2); }
    .promo-wrap { padding:0 22px; margin-top:28px; }
    ...
    .step-free { display:inline-block; margin-top:10px; background:#edf8ef; border:1px solid #cfe7d2; color:#2e7a43; border-radius:980px; padding:3px 11px; font-size:11.5px; font-weight:600; }
    ...
    .cta h2 { font-size:clamp(30px,4.4vw,50px); font-weight:700; letter-spacing:-.02em; margin-bottom:26px; color:var(--navy); }
    .cta p { font-size:18px; color:var(--text-muted); max-width:560px; margin:0 auto 26px; }
    .cta .pill { display:inline-block; margin-bottom:26px; background:#fff; border:1px solid var(--border); border-radius:980px; padding:8px 18px; font-size:14px; font-weight:600; color:var(--navy); }
...
<body>
  ...
  <header class="hero">
    ...
    <div class="hero-note anim d3"><span class="free-chip">Зарегистрируйтесь бесплатно — посмотрите личный кабинет без оплаты</span></div>
...
${slides(p)}
  ...
  <section class="section" id="how">
    <div class="section-inner">
      ...
      <div class="steps">
        <div class="step"><div class="step-num"></div><h3>Войдите по телефону</h3><p>Введите номер и промокод <b>WELCOME</b> — −10% на первую визу.</p><span class="step-free">Бесплатный вход</span></div>
...
${adv}
  ...
  <section class="cta">
    ...
    <p class="cta-free">Вход и просмотр кабинета — <b>бесплатно</b>.<br>Примените промокод <b>WELCOME</b>, если решите оформить визу с нами.</p>
  </section>
